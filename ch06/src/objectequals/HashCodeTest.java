...
class Employee{
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof Employee) {    //obj가 Employee의 인스턴스라면
			...
			if(this.empId == employee.empId)  //외부에서 입력한 사번과 원래사번이 일치한다면
				return true;
		}
		return false;
	}
	...
	@Override
	public int hashCode() {//int형인 empId를 반환
		return empId;
	}
}
public class HashCodeTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(emp1.equals(emp2));//equals재정의하면 true
		
		//hashCode값 바교 - 동등객체인지확인(문자열의 일치 확인)
